...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=3 python tools/test_net.py --config-file configs/da_faster_rcnn/e2e_da_faster_rcnn_R_50_FPN_WDT_voc_sd-1.yaml --ckpt /data/users/yang/code/sa_da_faster/output/?????????-50-C4_Weights/modle_final.pth
